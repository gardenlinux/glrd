...
- `glrd-manage` installed. See [Run GLRD](/how-to/releases/glrd/run-glrd.md).
- AWS credentials with write access to the S3 bucket when you intend to push changes with `--s3-update`. See [AWS authentication](/how-to/releases/glrd/run-glrd.md#aws-authentication-for-glrd-manage).
